...
class GetXModRouteObserverSample extends Sample {
  GetXModRouteObserverSample()
      : super(
          'lib/app/routes/app_route_observer.dart',
          overwrite: true,
        );

  @override
  String get content => '''import 'package:flutter/widgets.dart';
